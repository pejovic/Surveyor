...
makis.snet.adj <- adjust.snet(adjust = TRUE, result.units = "mm", survey.net = makis.snet, dim_type = "2D", sd.apriori = 3 ,  all = TRUE)
...
zadatak1.snet.adj <- adjust.snet(adjust = TRUE,  output = "report", survey.net = zadatak1.snet, dim_type = "2D", sd.apriori = 1 ,  all = FALSE)
...
plot_surveynet(snet = cut45, webmap = FALSE, net.1D = FALSE, net.2D = TRUE)
